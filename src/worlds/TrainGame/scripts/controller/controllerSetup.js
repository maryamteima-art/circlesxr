...
export class ControllerSystem {
    ...
    setupDesktopInput(){
        ...
        window.addEventListener('keydown', (event) => {
            switch(event.key) {
                case "j": this.gameSystem.handleInputAction('DECREMENT'); console.log(`${action} detected`); break;
                case "k": this.gameSystem.handleInputAction('INCREMENT'); console.log(`${action} detected`); break;
                // Add more as needed
            }
        });
